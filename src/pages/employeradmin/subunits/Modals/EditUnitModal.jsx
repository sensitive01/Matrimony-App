...
const EditUnitModal = ({ show, onClose, unit, onSave }) => {
  ...
  const uploadProfilePicture = async (file) => {
    ...
    try {
      const response = await axios.put(
        `https://api.edprofio.com/employer/uploadprofilepic/${unit.id}?fileType=profileImage`,
        formData,
        {
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://api.edprofio.com/employer/updateemployer/${unit.id}`,
        {
          ...formData,
                            ...
                            <button
                              ...
                              onClick={() => {
                                setFormData((prev) => ({
                                  ...prev,
                                  userProfilePic:
                                    unit.originalData.userProfilePic || "",
                                }));
