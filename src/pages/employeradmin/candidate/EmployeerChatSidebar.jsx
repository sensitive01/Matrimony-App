...
const EmployeerChatSidebar = ({ isOpen, onClose, candidate }) => {
  ...
  useEffect(() => {
    if (isOpen && employerAdminData?._id) {
      fetchEmployerDetails();
      fetchEmployerJobs();
    }
  }, [isOpen, employerAdminData]);
          ...
          setMessages((prevMessages) => {
            if (
              ...
              return chat.messages.map((msg) => ({
                ...
                avatar:
                  msg.sender === "employer"
                    ? employerAdminData.profilePicture ||
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      ...
      formData.append("employerName", employerAdminData.companyName);
      formData.append("employerImage", employerAdminData.profilePicture);
