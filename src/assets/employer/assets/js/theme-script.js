...
document.querySelector("html").setAttribute('data-layout', localStorage.getItem('layout') || 'horizontal-single');
...
document.querySelector("html").setAttribute('data-size', localStorage.getItem('size') || 'compact');
...
//		const savedLayout = localStorage.getItem('layout') || 'horizontal-single';
        const savedLayout = 'horizontal-single';
